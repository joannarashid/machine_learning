...
#accuracy = rep(0,7) #empty vector for accuracy values
...
#A ksvm classifier model trained on this data accurately predicts credit card 
#approval for approximately 86% of applicants when C = 1 and when C=100. 86% is
#the highest level of accuracy achieved amoung tested values of C. Lower values 
#of C classify a wider range of applications and higher values represent a more 
#narrow margin. So it seems that 1 is a better choice than 100 since the margin 
#for classifying points will be wider with the same classification accuracy.